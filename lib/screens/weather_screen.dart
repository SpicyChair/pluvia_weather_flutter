...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  String getIconByTimeAndID(int id, DateTime forecastTime, DateTime sunset, DateTime sunrise) {
    ...
    bool isNight =
        (forecastTime.isAfter(sunset) || forecastTime.isBefore(sunrise)) && forecastTime.isBefore(tomorrowSunrise);
