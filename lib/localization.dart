final Map<String, Map<String, String>> localizedValues = {
  ...
  'it': {
    ...
    'locationDisabledPrompt':
        'Per consentire a PLUVIA di mostrare il tempo nella posizione corrente, abilitare la posizione. ',
    ...
    'viewOnGithub': 'Visualizza Pluvia su GitHub ',
    ...
    'serverErrorBody':
        'PLUVIA non ha potuto ottenere dati. I server OpenWeatherMermap potrebbero essere irraggiungibili.',
    ...
    'useDefaultLocationOnStartup':
        "Utilizzare la posizione predefinita all'avvio dell'app ",
    'customAPIKeys': 'Chiavi API personalizzate. ',
    'owmKey': 'Inserisci la chiave API OpenWeather ',
    'mbKey': 'Inserisci la chiave API Mapbox ',
    'customKeyInfo':
        'Lasciare in bianco per utilizzare i valori predefiniti. Se le chiavi API non sono corrette, verranno utilizzati i valori predefiniti. ',
    'thankYouForUsing': 'Grazie per aver usato PLUVIA. ',
    'changelog': 'Changelog. ',
  ...
  'pl': {
    ...
    'weatherRadarAboutTitle': 'Informacje o radarze pogodowym ',
    'weatherRadarAboutBody':
        'Aplikacja Pluvia Weather używa "Weather Radar" ze strony internetowej "OpenWeatherMap". Wspiera przeglądanie opadów, ciśnienia, temperatury, prędkości wiatru i zachmurzenia na całym świecie. Może to prowadzić do większego wykorzystania danych. ',
    'lastUpdatedAt': 'Ostatnia aktualizacja o ',
    'locationDisabledPrompt':
        'Aby Pluvia Weather pokazywała pogodę w twojej bieżącej lokalizacji, włącz lokalizację. ',
    ...
    'tapTheSearchBar': 'Naciśnij powyższy pasek wyszukiwania, aby znaleźć lokalizację ',
    'tapToSeeWeatherCurrent': 'Dotknij, aby zobaczyć pogodę dla bieżącej lokalizacji ',
    'use24HourTime': 'Użyj czasu 24 godzinnego ',
    'appLanguage': 'Język aplikacji ',
    'advancedSettings': 'Ustawienia zaawansowane ',
    'defaultLocation': 'Lokalizacja domyślna ',
