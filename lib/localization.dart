...
'OpenWeatherMap': 'Он поддерживает просмотр прогнозов осадков, давления, температуры, скорости ветра и облачности в глобальном масштабе. Это может привести к повышенному использованию данных. ',
  ...
  'sq': {
   ...
   'sr-cy': {
    ...
    'weatherRadar': 'Метеоролошки радар ',
    'weatherRadarAboutTitle': 'О метеоролошком радару ',
    'weatherRadarAboutBody':
        '"Метеоролошки радар Плувиа" користи веб страницу "ОпенВеатхерМап" Она подржава прогнозе: падавина, притиска, температуре, брзине ветра и облака на глобалном нивоу. Ово може довести до веће употребе података. ',
	'lastUpdatedAt': 'Последњи пут ажурирано у  ',
    'locationDisabledPrompt':
        'Да би се Плувиа Време приказали временске прилике на вашој тренутној локацији, Омогућите локацију. ',
    'darkMode': 'Тамни режим ',
    'useFahrenheit': 'Користите Фаренхајте ',
    ...
    'openLocationSettings': 'Отвори Подешавања Локације ',
    'close': 'Затвори ',
    'retry': 'Покушај поново ',
    'serverErrorTitle': 'Серверска грешка ',
    'serverErrorBody':
        'Плувиа Време не може да добије податке. Могуће је да сервери ОпенВеатхерМап не раде. ',
    'networkErrorText':
        'Омогућите ВајФај или мобилне податке и покушајте поново ',
    'gettingLocationMessage': 'Добијање локације ... ',
    'temperature': 'Температура ',
    'precipitation': 'Падавине ',
    'addLocation': 'Додај локацију ',
    'pressAndHold': 'Притисните и задржите локацију да бисте је избрисали ',
    'searchForLocation': 'Потражите локацију ',
    'tapTheSearchBar':
        'Додирните траку за претрагу да бисте пронашли локацију ',
    'tapToSeeWeatherCurrent':
        'Додирните да бисте видели време за тренутну локацију ',
    'use24HourTime': 'Користи 24-часовно време ',
    'appLanguage': 'Језик апликације ',
    'advancedSettings': 'Напредна подешавања ',
    'defaultLocation': 'Подразумевана локација ',
    'useDefaultLocationOnStartup':
        'Користи подразумевану локацију приликом покретања апликације ',
    'customAPIKeys': 'Прилагођени АПИ кључ ',
    ...
    'getAKeyNote':
        'НАПОМЕНА: Можда ће бити потребно неко време да се ваш кључ активира. ',
    'serverErrorText':
        'Временски сервер је блокирао ваш захтев. Користите свој АПИ кључ. '
     },
 'sr': {
    'current': 'Trenutna ',
    'forecast': 'Prognoza ',
    ...
    'pressure': 'Pritisak ',
    'currentLocationTitle': 'Trenutna lokacija ',
    'weatherRadar': 'Meteorološki radar ',
    'weatherRadarAboutTitle': 'O meteorološkom radaru ',
    'weatherRadarAboutBody':
        '"Meteorološki radar Pluvia" koristi veb stranicu "OpenWeatherMap" Ona podržava prognoze: padavina, pritiska, temperature, brzine vetra i oblaka na globalnom nivou. Ovo može dovesti do veće upotrebe podataka. ',
	'lastUpdatedAt': 'Poslednji put ažurirano u  ',
    'locationDisabledPrompt':
        'Da bi se Pluvia Vreme prikazali vremenske prilike na vašoj trenutnoj lokaciji, Omogućite lokaciju. ',
    'darkMode': 'Tamni režim ',
    'useFahrenheit': 'Koristite Farenhajte ',
    'refreshToSee': 'Osvežite da biste videli promene ',
    'windSpeedUnit': 'Jedinica za brzinu vetra ',
    'aboutPluvia': 'O Pluvia Vreme ',
    'viewOnGithub': 'Pogledajte Pluvia Vreme na Github-u ',
    'localTime': 'Lokalno vreme ',
    'loading': 'Učitavanje ',
    'chooseLocationToView': 'Izaberite lokaciju da biste videli vreme. ',
    'openLocationSettings': 'Otvori Podešavanja Lokacije ',
    'close': 'Zatvori ',
    'retry': 'Pokušaj ponovo ',
    'serverErrorTitle': 'Serverska greška ',
    'serverErrorBody':
        'Pluvia Vreme ne može da dobije podatke. Moguće je da serveri OpenWeatherMap ne rade. ',
    'networkErrorText':
        'Omogućite WiFi ili mobilne podatke i pokušajte ponovo ',
    'gettingLocationMessage': 'Dobijanje lokacije ... ',
    'temperature': 'Temperatura ',
    'precipitation': 'Padavine ',
    'addLocation': 'Dodaj lokaciju ',
    'pressAndHold': 'Pritisnite i zadržite lokaciju da biste je izbrisali ',
    'searchForLocation': 'Potražite lokaciju ',
    'tapTheSearchBar':
        'Dodirnite traku za pretragu da biste pronašli lokaciju ',
    'tapToSeeWeatherCurrent':
        'Dodirnite da biste videli vreme za trenutnu lokaciju ',
    'use24HourTime': 'Koristi 24-časovno vreme ',
    'appLanguage': 'Jezik aplikacije ',
    'advancedSettings': 'Napredna podešavanja ',
    'defaultLocation': 'Podrazumevana lokacija ',
    'useDefaultLocationOnStartup':
        'Koristi podrazumevanu lokaciju prilikom pokretanja aplikacije ',
    'customAPIKeys': 'Prilagođeni API ključ ',
    ...
    'getAKeyNote':
        'NAPOMENA: Možda će biti potrebno neko vreme da se vaš ključ aktivira. ',
    'serverErrorText':
        'Vremenski server je blokirao vaš zahtev. Koristite svoj API ključ. '
  },
  'sv': {
    'current': 'Nuvarande ',
    'forecast': 'Prognos ',
